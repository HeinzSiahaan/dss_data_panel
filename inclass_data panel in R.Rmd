...
```
Result : Kita akan membuang data `Hong Kong S.A.R. of China` karena jumlah datanya 12 sangat jauh dengan data optimal 17.
...
- Singapore dg tingkat persepsi korupsi terendah
- Generally di SEA persepsi orang terhadap korupsi itu tinggi, mungkin di SEA kebanyakan percaya kalo pemerintah mereka akan korupsi
...
ladder_train <- ladder_train %>% 
  droplevel() %>%     # menghapus informasi waktu yang diambil sebagai data test (tahun 2022)
